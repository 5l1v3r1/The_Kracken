...
"
 ...
 echo -e "\033[33;5mEnter target address\033[0m"
 echo -n "address: "
 read address

  xcowsay Releasing the Kracken and starting the NMAP Nightmare
   sleep 2
